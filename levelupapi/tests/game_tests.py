...
class GameTests(APITestCase):
    def setUp(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED) # pylint: disable=no-member
    ...
    def test_change_game(self):
        ...
        game.number_of_players = 4
        game.gamer_id = 1
        game.description = "it's a game yo"
        game.save()
        ...
        data = {
            ...
            "maker": "Hasbro",
            "numberOfPlayers": 4,
            "description": "its totally not a game yo"
        }
